...
class AccountMenu {
	...
	public function init_default_endpoints() {
		...
		$endpoints = array(
			'dashboard'       => __( 'Dashboard', 'customize-my-account-page' ),
			'orders'          => __( 'Orders', 'customize-my-account-page' ),
			'downloads'       => __( 'Downloads', 'customize-my-account-page' ),
			'edit-address'    => __( 'Addresses', 'customize-my-account-page' ),
			'payment-methods' => __( 'Payment Methods', 'customize-my-account-page' ),
			'edit-account'    => __( 'Account Details', 'customize-my-account-page' ),
			'customer-logout' => __( 'Logout', 'customize-my-account-page' ),
		);

		$tgwc_woocommerce_account_menu_items = 'woocommerce_account_menu_items';
		$tgwc_endpoints 					 = apply_filters( $tgwc_woocommerce_account_menu_items, $endpoints, $endpoints_slugs );
		...
		if ( class_exists( 'WC_Memberships' ) ) {
			...
			$endpoints['members-area']       = __( 'Memberships', 'customize-my-account-page' );
		}

		if ( class_exists( 'WC_Subscriptions' ) ) {
			$endpoints_slugs['subscriptions'] = get_option( 'woocommerce_myaccount_subscriptions_endpoint', 'subscriptions' );
			$endpoints['subscriptions']       = __( 'Subscriptions', 'customize-my-account-page' );
		}
		...
		if ( is_admin() && function_exists( 'wc_memberships_for_teams' ) ) {
			...
			$endpoints['teams']       = __( 'Team', 'customize-my-account-page' );
		}
