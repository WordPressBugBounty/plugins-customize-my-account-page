...
<div id="<?php echo esc_attr( $key ); ?>" class="tgwc-tabs-panel"
	...
	<div class="endpoint settings-table">
		<div class="settings-table-wrapper">
			...
			<div class="row">
				<div class="col-label">
					<p><?php esc_html_e( 'Endpoint Label', 'customize-my-account-page' ); ?></p>
					<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'The display name shown for this tab in the My Account menu.', 'customize-my-account-page' ); ?>">
		...
		<?php if ( ! empty( $endpoint['slug'] ) ) : ?>
			<div class="row">
				...
				<p>	<?php esc_html_e( 'Slug', 'customize-my-account-page' ); ?></p>
					<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'The text that appears in the URL for this tab.', 'customize-my-account-page' ); ?>">
						<?php Icon::get_svg_icon( 'tooltip', true ); ?>
					</span>
				</div>
				<div class="col-input">
		...
		<?php endif; ?>
			...
			<div class="row">
				<div class="col-label">
					<p><?php esc_html_e( 'Endpoint Icon', 'customize-my-account-page' ); ?></p>
					<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'Choose or upload an icon to display for this tab on the My Account page.', 'customize-my-account-page' ); ?>">
						<?php Icon::get_svg_icon( 'tooltip', true ); ?>
					</span>
				</div>
				<div class="col-input">
			...
			<div class="row">
				<div class="col-label">
					...
					<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'Choose which types of users (e.g., customers, shop managers, or administrators) can view this tab.', 'customize-my-account-page' ); ?>">
						<?php Icon::get_svg_icon( 'tooltip', true ); ?>
					</span>
				</div>
				<div class="col-input">
			...
			<div class="row">
				<div class="col-label">
					...
					<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'Add content to show on this tab on My Account page. Supports text, shortcodes, media, and HTML.', 'customize-my-account-page' ); ?>">
						<?php Icon::get_svg_icon( 'tooltip', true ); ?>
					</span>
				</div>
				<div class="col-input">
				<?php
					$tgwc_content = $endpoint['content'];

				if ( '' === trim( $tgwc_content ) ) {
					$tgwc_content = '<p></p>';
				}
			...
			<div class="row">
				...
				<div class="col-input">
					<select name="tgwc_endpoints[<?php echo esc_attr( $key ); ?>][content_position]" class="tgwc_custom_content_position">
						<option value="before" <?php selected( 'before', $endpoint['content_position'] ); ?>><?php esc_html_e( 'Before default content', 'customize-my-account-page' ); ?></option>
						<option value="main" <?php selected( 'main', $endpoint['content_position'] ); ?>><?php esc_html_e( 'Override default content', 'customize-my-account-page' ); ?></option>
						<option value="after" <?php selected( 'after', $endpoint['content_position'] ); ?>><?php esc_html_e( 'After default content', 'customize-my-account-page' ); ?></option>
					</select>
				</div>
			</div>
			<!-- ./ Custom content position -->
